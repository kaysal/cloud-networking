...
iptables -t nat -A POSTROUTING -o eth0 -d ${ONPREM1} -j SNAT --to-source ${ETH0}
iptables -t nat -A POSTROUTING -o eth0 -d ${ONPREM2} -j SNAT --to-source ${ETH0}

iptables -t nat -A POSTROUTING -o eth1 -d ${SPOKE_80} -j SNAT --to-source ${ETH1}
iptables -t nat -A POSTROUTING -o eth1 -d ${SPOKE_81} -j SNAT --to-source ${ETH1}
