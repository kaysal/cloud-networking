locals {
  peer_ip   = data.terraform_remote_state.host.outputs.vpn_gw_ip_eu_w2_addr
  local_vti = "169.254.200.2"
...
module "vpn_to_host" {
  ...
  project_id    = data.terraform_remote_state.mango.outputs.mango_project_id
