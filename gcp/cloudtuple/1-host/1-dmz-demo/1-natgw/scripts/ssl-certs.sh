...
export DIRECTORY=~/tf/credentials/ssl/certs-dmz
...
openssl x509 -req -days 365 \
...

  {
    ...
    echo CloudTuple
    echo prod app team
    echo v6.demo.prod.cloudtuple.com
    echo prod@cloudtuple.com
    echo
    echo
  } | openssl req \
...

  {
    ...
    echo CloudTuple
    echo dev app team
    echo v6.demo.dev.cloudtuple.com
    echo dev@cloudtuple.com
    echo
    echo
  } | openssl req \
