locals {
  cgw1_tunnel_ip = data.terraform_remote_state.vpc.outputs.vpn_gw1_ip_us_e1_addr
  cgw2_tunnel_ip = data.terraform_remote_state.vpc.outputs.vpn_gw2_ip_us_e1_addr
}
