locals {
  cgw2_tunnel1_aws_vti = "${data.terraform_remote_state.aws_us_e1_vpc1.aws_cgw2_tunnel1_vgw_inside_address}"
  cgw2_tunnel2_aws_vti = "${data.terraform_remote_state.aws_us_e1_vpc1.aws_cgw2_tunnel2_vgw_inside_address}"
  cgw2_tunnel1_gcp_vti = "${data.terraform_remote_state.aws_us_e1_vpc1.gcp_cgw2_tunnel1_cgw_inside_address}"
  cgw2_tunnel2_gcp_vti = "${data.terraform_remote_state.aws_us_e1_vpc1.gcp_cgw2_tunnel2_cgw_inside_address}"
}
