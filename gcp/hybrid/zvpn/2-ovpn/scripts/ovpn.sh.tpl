...
echo ""
echo "${CLIENT1}: gcloud compute scp ${SERVER_NAME}:/home/admin_cloudtuple_com/clients/files/${CLIENT1}.ovpn ."
echo "${CLIENT2}: gcloud compute scp ${SERVER_NAME}:/home/admin_cloudtuple_com/clients/files/${CLIENT2}.ovpn ."
echo ""
echo "done!"
EOF
