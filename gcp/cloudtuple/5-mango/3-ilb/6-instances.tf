...
resource "google_dns_record_set" "bastion_public" {
  managed_zone = "${data.google_dns_managed_zone.public_mango_cloudtuple.name}"
  name         = "bastion.mango.${data.google_dns_managed_zone.public_mango_cloudtuple.dns_name}"
  type         = "A"
  ttl          = 300
