...
server:
        ...
        local-data: "${DNS_NAME2} A ${A_RECORD2}"
        local-data: "${DNS_NAME3} A ${A_RECORD3}"
        local-data: "${DNS_NAME4} A ${A_RECORD4}"
        local-data: "${DNS_NAME5} A ${A_RECORD5}"
        local-data: "${DNS_NAME6} A ${A_RECORD6}"
        local-data: "${DNS_NAME7} A ${A_RECORD7}"
...
forward-zone:
        name: "${SPOKE1_DNS}"
        forward-addr: ${SPOKE1_FWD}

forward-zone:
        name: "${SPOKE2_DNS}"
        forward-addr: ${SPOKE2_FWD}
