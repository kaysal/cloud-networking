locals {
  vyosa_tunnel_gcp_vti = "${data.terraform_remote_state.aws_eu_w1_vpc1.vyosa_gcp_tunnel_inside_address}"
  vyosb_tunnel_gcp_vti = "${data.terraform_remote_state.aws_eu_w1_vpc1.vyosb_gcp_tunnel_inside_address}"
  vyosa_tunnel_aws_vti = "${data.terraform_remote_state.aws_eu_w1_vpc1.vyosa_aws_tunnel_inside_address}"
  vyosb_tunnel_aws_vti = "${data.terraform_remote_state.aws_eu_w1_vpc1.vyosb_aws_tunnel_inside_address}"
}
