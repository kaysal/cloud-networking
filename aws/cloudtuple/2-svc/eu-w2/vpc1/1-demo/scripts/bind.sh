...
export LOCAL_ZONE=west2.cloudtuple.com
export LOCAL_ZONE_FILE=/etc/bind/db.west2.cloudtuple.com
export LOCAL_ZONE_INV=10.18.172.in-addr.arpa
export LOCAL_ZONE_INV_FILE=/etc/bind/db.west2.cloudtuple.com.inv
...
export REMOTE_AWS_ZONE=west1.cloudtuple.com
export REMOTE_AWS_NAME_SERVER_IP=172.16.10.100
...
wget https://storage.googleapis.com/salawu-gcs/aws/bind9/db.west2.cloudtuple.com.text
cp db.west2.cloudtuple.com.text $LOCAL_ZONE_FILE

wget https://storage.googleapis.com/salawu-gcs/aws/bind9/db.west2.cloudtuple.com.inv.text
cp db.west2.cloudtuple.com.inv.text $LOCAL_ZONE_INV_FILE
