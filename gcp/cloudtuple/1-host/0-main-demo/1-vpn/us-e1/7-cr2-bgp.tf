...
resource "google_compute_router_interface" "aws_us_e1_vpc1_cgw2_tunnel1" {
  ...
  ip_range = "${data.terraform_remote_state.aws_us_e1_vpc1.gcp_cgw2_tunnel1_cgw_inside_address}/30"
  region = "us-east1"
}
...
resource "google_compute_router_interface" "aws_us_e1_vpc1_cgw2_tunnel2" {
  ...
  ip_range = "${data.terraform_remote_state.aws_us_e1_vpc1.gcp_cgw2_tunnel2_cgw_inside_address}/30"
  region = "us-east1"
}
...
resource "google_compute_router_peer" "aws_us_e1_vpc1_cgw2_tunnel1" {
  name                      = "${var.name}aws-us-e1-vpc1-cgw2-tunnel1"
  router                    = "${google_compute_router.us_e1_cr2.name}"
  peer_ip_address           = "${data.terraform_remote_state.aws_us_e1_vpc1.aws_cgw2_tunnel1_vgw_inside_address}"
  peer_asn                  = 65010
...
resource "google_compute_router_peer" "aws_us_e1_vpc1_cgw2_tunnel2" {
  name                      = "${var.name}aws-us-e1-vpc1-cgw2-tunnel2"
  router                    = "${google_compute_router.us_e1_cr2.name}"
  peer_ip_address           = "${data.terraform_remote_state.aws_us_e1_vpc1.aws_cgw2_tunnel2_vgw_inside_address}"
  peer_asn                  = 65010
