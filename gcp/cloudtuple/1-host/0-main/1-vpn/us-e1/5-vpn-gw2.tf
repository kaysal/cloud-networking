locals {
  cgw2_tunnel1_ip = "${data.terraform_remote_state.aws_us_e1_vpc1.aws_cgw2_tunnel1_address}"
  cgw2_tunnel2_ip = "${data.terraform_remote_state.aws_us_e1_vpc1.aws_cgw2_tunnel2_address}"
}
